...
<body>
    ...
    <div class="container">
        <button class="button" onclick="location.href='addteacher.jsp'">Add Teacher</button>
        <button class="button" onclick="location.href='viewteacher.jsp'">View Teacher Details</button>
        <button class="button" onclick="location.href='updateteacher.jsp'">Update Teacher</button>
