...
if ("POST".equalsIgnoreCase(request.getMethod())) {
    ...
    try {
        ...
        if (rs.next()) {
            // If registration number exists, check if mobile number and email match
            String dbMobileNumber = rs.getString("mobile_no");
            String dbEmail = rs.getString("email");
            if (mobileNumber.equals(dbMobileNumber) && email.equals(dbEmail)) {
                // Redirect to student-change-password.jsp if details match
            ...
            // Display error message if registration number is not valid
